...
class Isotope(object):
    def __init__(self, Symbol, Atomic_number, Mass_number, half_life, decay_constant, list_sig_g_e, list_sig_g_b_r):
        ...
        self.list_sig_g_b_r = 0.01*list_sig_g_b_r
        return
...
Cadmium_115 = Issotope("Cd", 48, 115, 192456, 3.6E-6, Cd_115_g_e, Cd_115_b_r)
...
Ir_192_g_e = [295.96, 308.46, 316.51, 468E-7.1, 604.41, 612.47]
...
Niobium_94m = Isotope("Nb", 41, 94, 37E-5.78, 1.84E-3, 871.09, 0.5)
...
Osmium_186 = Isotope("Os", 76, 186, 6.3E+22, 1.1E-23, 27E-57.7, 100)
Os_190m_g_e = [18E-6.72, 361.14, 502.53, 616.08]
...
Rubidium_86 = Issotope("Rb", 37, 86, 1.61E+6, 4.3E-7, 1076.64, 9)
